 ...
 *
 * Class Name: TaskCharacteristicChangeIndication
 ******************************************************************************/
...
/**
 * Task to enable/disable indication
 */

class TaskCharacteristicChangeIndication extends TaskCharacteristic {
    private static String TAG = "TaskChangeIndication";

    private boolean enable;
    private PeripheralCallback callback;
    private BluetoothGattDescriptor descriptor;

    public TaskCharacteristicChangeIndication(Characteristic characteristic, int timeout, boolean enable) {
        super(characteristic, timeout);
        this.enable = enable;
        final TaskCharacteristicChangeIndication task = this;
    ...
    {
        return String.format("Change Indication (Address:%s)", Peripheral.getAddress());
    }
}
