package com.jianzhi.glitter.pictureSelector;
...
public final class InsGallery {
    ...
    public static void openGallery(Activity activity, ImageEngine engine, CacheResourcesEngine cacheResourcesEngine, List<LocalMedia> selectionMedia,int mimetype) {
        applyInstagramOptions(activity.getApplicationContext(), PictureSelector.create(activity)
